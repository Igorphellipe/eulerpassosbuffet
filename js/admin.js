// SERVICES é um alias para servicesData (fonte única de verdade em servicesData.js)
// Os menus do admin e do site (index) são lidos do mesmo arquivo: js/servicesData.js
